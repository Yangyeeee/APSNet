...
def plot_3d_point_cloud(
    ...
    **kwargs
    ...
    if pc != None:
        ...
        sc = ax.scatter(x, y, z, marker=marker, c="r", s=50, alpha=alpha, *args, **kwargs)
    if org != None:
        x1, y1, z1 = (org[:, 0], org[:, 1], org[:, 2])
        sc = ax.scatter(x1, y1, z1, marker=marker, c=c, s=s, alpha=alpha, *args, **kwargs)
    ...
    if show:
        # plt.show()
        plt.savefig("./image/mat_{}_{}.png".format(epoch, title), format="png", dpi=300)
